...
{
    public partial class DonationController : UIViewController, IPKPaymentAuthorizationViewControllerDelegate
    {
        public DonationController(IntPtr handle) : base(handle)
        {
        }

        PassKit.PKPaymentToken paymentToken;
        ...
        readonly NSString[] supportedNetworks = {
            ...
            PassKit.PKPaymentNetwork.Discover,
        ...
        public UILabel ProductTitleLabel { get; set; } = new UILabel();

        [Outlet("productPriceLabel")]
        public UILabel ProductPriceLabel { get; set; }= new UILabel();

        [Outlet("productDescriptionView")]
        public UITextView ProductDescriptionView { get; set; }= new UITextView();

        [Outlet("applePayView")]
        public UIView ApplePayView { get; set; } = new UIView();
        ...
        public void ApplyPayButtonClicked()
        {
            ...
            paymentRequest.MerchantIdentifier = "STMINARETRTCNTR";
        ...
        PKPaymentSummaryItem[] MakeSummaryItems(bool requiresInternationalSurcharge)
        {
            ...
            var productSummaryItem = PKPaymentSummaryItem.Create("Sub-total", new NSDecimalNumber(int.Parse(this.DonationAmount.Text)));
